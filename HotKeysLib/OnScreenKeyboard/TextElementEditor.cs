...
{
	public class TextElementEditor : System.ComponentModel.Design.CollectionEditor
	{
		public TextElementEditor(Type type) : base(type){}
		...
		{
			return new Type[] {typeof(KeyboardLayoutKeyTextElement)};
		}

		protected override Type CreateCollectionItemType()
		{
			return typeof(KeyboardLayoutKeyTextElement);
		}
