...
{
	public class LayoutRowsEditor : System.ComponentModel.Design.CollectionEditor
	{
		public LayoutRowsEditor(Type type) : base(type){}
		...
		{
			return new Type[] {typeof(KeyboardLayoutRow)};
		}

		protected override Type CreateCollectionItemType()
		{
			return typeof(KeyboardLayoutRow);
		}
